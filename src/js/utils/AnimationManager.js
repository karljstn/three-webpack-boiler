...
export default class AnimationManager {
    ...
    animFade(options) {
        ...
        this.actionType[options.startAnimation].crossFadeTo(
            this.actionType[options.endAnimation],
            options.duration,
            true
        )
    ...
    _setupMultipleAnimations(action, actionName, animationNumber) {
        this.actionType[actionName] = this.mixer.clipAction(
            this.animations[animationNumber]
        )
